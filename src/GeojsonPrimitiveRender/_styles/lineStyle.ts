...
import type { PolylineEntityStyle } from '../_config/entityTyping';
import type { GeoJsonLineStyle } from '../_config/typing';

const LineConfig2Style = async (data: Record<string, any>[], jsonStyle: GeoJsonLineStyle) => {
