...
import type { MixEntityStyle } from '../_config/entityTyping';
import type { GeoJsonMixStyle } from '../_config/typing';

const MixConfig2Style = async (data: Record<string, any>[], jsonStyle: GeoJsonMixStyle) => {
  ...
  const image =
    spriteOption && imageName
      ? image2canvas(spriteOption.spriteImage, spriteOption.json[imageName])?.toDataURL()
      : undefined;
