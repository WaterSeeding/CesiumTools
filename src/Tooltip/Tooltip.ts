...
import { DomUtil, Widget } from "./common/index";
...
class Tooltip extends Widget {
  ...
  constructor(viewer: Cesium.Viewer, options: TooltipOptions = {}) {
   ...
   */
  protected _updateWindowCoord(windowCoord: Cesium.Cartesian2) {
